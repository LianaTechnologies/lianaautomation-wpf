 ...
 *
 * @param $fields    Fields
 * @param $entry     WPForms param (unused here)
 * @param $form_id   WPForms form id (should be used here somewhere)
 * @param $form_data WPForms structure of the form (unused here)
 * 
 * @return null
 */
function Liana_WPForms_Process_Entry_save($fields, $entry, $form_id, $form_data)
{
...
add_action('wpforms_process_entry_save', 'Liana_WPForms_Process_Entry_save', 10, 4);
